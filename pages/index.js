    ...
    <Layout>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.ctaButtons}>
          ...
          <a
            href="https://github.com/your-org/tensorus"
            target="_blank"
      ...
      <section className={styles.section}>
        ...
        <ul className={styles.featureList}>
          <li>
            <strong>AI-Powered Agents:</strong> Tensorus utilizes AI agents to organize
            and use data for customized solutions. The system learns your needs and
            adjusts accordingly.
          </li>
          <li>
            <strong>Dynamic Data Processing:</strong> Unlike static databases,
            Tensorus actively transforms and connects data, allowing for much faster
            and more intuitive analysis.
          </li>
          <li>
            <strong>Universal Data Handling:</strong> Whether it’s text, numbers, images,
            or something else, Tensorus handles all types of data in a unified, dynamic way.
          </li>
          <li>
            <strong>Efficiency and Speed:</strong> Tensorus efficiently stores and
            retrieves data by breaking it into smaller, more manageable components,
